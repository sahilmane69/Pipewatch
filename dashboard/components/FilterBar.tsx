...
interface FilterBarProps {
  ...
  totalCount: number;
  statusCounts?: Record<PipelineStatus | "All", number>;
}
          ...
          {STATUS_OPTIONS.map((status) => {
            ...
            return (
              <button
                ...
                className={`px-2.5 py-1 rounded text-[11px] font-medium whitespace-nowrap transition-colors flex items-center gap-1.5 ${
                  isActive
